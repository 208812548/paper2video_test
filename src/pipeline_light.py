...
os.environ["GEMINI_API_KEY"] = "AIzaSyAsiXKi6rMopOamHrWKEkUARiII3etFvTM"
# os.environ["OPENAI_API_KEY"] = "AIzaSyAsiXKi6rMopOamHrWKEkUARiII3etFvTM"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name_t', type=str, default='gemini2.5-pro')
    parser.add_argument('--model_name_v', type=str, default='gemini2.5-pro')
    parser.add_argument('--paper_latex_root', type=str, default='')
    ...
    parser.add_argument('--reftext', type=str, default=None)
